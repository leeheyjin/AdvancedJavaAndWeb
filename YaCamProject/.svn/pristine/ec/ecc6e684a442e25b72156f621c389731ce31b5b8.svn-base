...
<body>
	<br>
        <div class="container mt-3">
          ...
          <a class="navbar-brand" href="<%=request.getContextPath()%>/LHH/notice/notice.jsp">
            <img id="imges" src="../../imges/btn_back.png" alt="" width="30" height="24">
          </a>
          
            <h3 style="text-align: center;"><img src="../../imges/promotion.png" style="width: 50px;">&nbsp;공지사항 등록</h3>
            <form method="post" enctype="multipart/form-data" action="<%=request.getContextPath()%>/noticeInsert.do">
              <hr><br>
              <div class="mb-3">
