...
<div class="container mt-3">
			<br>
           <a class="navbar-brand" href="<%=request.getContextPath()%>/LHH/question/question.jsp">
            <img id="imges" src="../../imges/btn_back.png" alt="" width="30" height="24">
          </a>
            <h3 style="text-align: center;"><img src="../../imges/Q&A.png" style="width: 50px;">&nbsp;문의사항 등록</h3><hr>
            <form method="post" enctype="multipart/form-data" action="<%=request.getContextPath()%>/questionInsert.do">
