...
<nav class="navbar navbar-light bg-light">
        ...
        <%if(vo!=null && "관리자".equals(vo.getMem_grade())){%>
          <button type="button" class="btn btn-dark" style="float: right;" onclick="location.href='${mypath}/YaCamProject/LHH/notice/noticeInsert.jsp'">공지사항등록(관리자)</button>
          <%} %>
        </div>         
          <div id="result"></div>
      <div id="pageList"></div>
