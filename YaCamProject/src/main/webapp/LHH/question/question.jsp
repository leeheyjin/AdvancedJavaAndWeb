...
$(function (){
	questionPageServer(1);
	
	//검색이벤트
	$('#search').on('click', function(){
		//stype - mem_id, que_ttl, que_dtl
		//sword - 입력한 값
		questionPageServer(1);
	})
    ...
    $(document).on('click', '.pageno', function () {
        ...
        questionPageServer(currentPage);
      })
...
<nav class="navbar navbar-light bg-light">
      ...
      <br>
          ...
          <%if(vo!=null) { %>
              <button type="button" class="btn btn-light" style="float: right;" onclick="location.href='${mypath}/YaCamProject/LHH/question/QuestionInsert.jsp'">글쓰기</button>
              <%} %>
      <div id="pageList"></div>
        </div>
    ...
    <div id="search" class="container-fluid">
      <form class="d-flex">
        <select id="stype">
          <option value="que_ttl">제목</option>
          <option value="mem_id">작성자</option>
          <option value="que_dtl">내용</option>
        </select>
