...
<div id="main_contaner">
	<div id="header">
	    <header id="head_box" style="font-size: xx-large;">블랙리스트 목록<br><br><hr></header>
   		<nav id="nav">
        <div id="nav_myinfo">
	        <div>
	...
	<div id="body">
		<table border="1">
				<tr>
					<th class = "th" >블랙리스트 번호</th>
					<th class = "th" >아이디</th>
					<th class = "th" >블랙리스트 날짜</th>
					<th class = "th" ></th>
				</tr>
			<%for(BlackListVO vo: list){ %>
				<tr>
					...
					<td><%=vo.getMem_id()%></td>
					<td><%=vo.getMem_id()%></td>
					<td><input type="button" value="블랙리스트 해제" class="noblack" name="<%=vo.getMem_id()%>"></td>
				</tr>
			<%} %>
		</table>
	</div>
